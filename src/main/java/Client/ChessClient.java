...
import javax.swing.*;
import Server.GameSessionInterface;
import java.awt.*;
...
public class ChessClient extends JFrame 
{
	...
	public static boolean ipEntered = true;				// when let the client know when the user has entered the IP
